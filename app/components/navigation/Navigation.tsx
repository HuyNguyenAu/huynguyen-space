        ...
        <div className="flex justify-center w-full">
            <div className="w-full flex flex gap-x-18 w-fit border rounded-lg border-[#F9DEC9] rounded-lg bg-[#F9DEC9]">
                ...
                <div className="p-3 pl-10 grow flex flex gap-x-10 bg-[#1B2432] rounded-r-lg">
                    <div className="grow flex flex gap-x-6 justify-center items-center">
                    ...
                    <div className="flex flex gap-x-2.5 items-center">
                        <ExternalLink href="https://github.com/HuyNguyenAu">
                        ...
                        <ExternalLink href="https://www.linkedin.com/in/huy-nguyen-454a6016a">
                            <svg className="fill-[#F9DEC9]" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
